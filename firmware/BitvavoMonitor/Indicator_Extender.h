...
/* PCA9555 bit index on SenseCAP (IO1_0 = bit 8, IO1_2 = bit 10). Cast by bit index so
 * hideakitai PCA95x5 (high-byte pins named P10..P17) and Anitracks builds agree. */
#define EXPANDER_IO_RP2040_RESET    ((decltype(PCA95x5::Port::P04))8)

#define EXPANDER_IO_BMP_PWR         ((decltype(PCA95x5::Port::P04))10)
